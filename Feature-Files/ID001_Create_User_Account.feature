Feature: Account Creation on SmartEats

  As a prospective user of SmartEats,
  I want to create an account on the SmartEats application,
  So that I can access personalized meal plans and nutritional advice tailored to my dietary goals.
